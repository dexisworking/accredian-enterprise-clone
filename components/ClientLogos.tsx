      ...
      <div className="w-full flex justify-center items-center mt-2">
        ...
        <div className="sm:hidden overflow-hidden relative w-full">
          <div className="flex mt-4 whitespace-nowrap animate-marquee">
            ...
            <div className="flex justify-center items-center px-8" data-cur="cursor"><img src="https://storage.googleapis.com/accredian-assets/Frontend_Assests/Images/Accredian-react-site-images/other/crif.png" alt="client" className="w-14 h-14 sm:w-20 sm:h-20 object-contain" /></div>
            ...
            <div className="flex justify-center items-center px-8" data-cur="cursor"><img src="https://storage.googleapis.com/accredian-assets/Frontend_Assests/Images/Accredian-react-site-images/other/bayer.svg" alt="client" className="w-14 h-14 sm:w-20 sm:h-20 object-contain" /></div>
            <div className="flex justify-center items-center px-8" data-cur="cursor"><img src="https://storage.googleapis.com/accredian-assets/Frontend_Assests/Images/Accredian-react-site-images/other/rel.png" alt="client" className="w-14 h-14 sm:w-20 sm:h-20 object-contain" data-cur="cursor" /></div>
            <div className="flex justify-center items-center px-8"><img src="https://storage.googleapis.com/accredian-assets/Frontend_Assests/Images/Accredian-react-site-images/other/hcl.png" alt="client" className="w-14 h-14 sm:w-20 sm:h-20 object-contain" /></div>
            <div className="flex justify-center items-center px-8"><img src="https://storage.googleapis.com/accredian-assets/Frontend_Assests/Images/Accredian-react-site-images/other/ibm.png" alt="client" className="w-14 h-14 sm:w-20 sm:h-20 object-contain" /></div>
